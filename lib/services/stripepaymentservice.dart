import 'dart:convert';
import 'package:pshopapp/controllers/paymentcontroller.dart';
      ...
      await Stripe.instance
          .initPaymentSheet(
              ...
              paymentSheetParameters: SetupPaymentSheetParameters(
                  ...
                  merchantDisplayName: 'vishal kochiyaniya',
                  customerId:paymentIntent!['customer'] ,
                  //applePay:const PaymentSheetApplePay(merchantCountryCode: 'India',),
                  googlePay:const PaymentSheetGooglePay(merchantCountryCode: "India",testEnv: true),
